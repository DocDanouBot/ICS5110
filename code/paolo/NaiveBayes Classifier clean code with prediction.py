...
#print ("The performance of the Gaussian Naive Bayes is: %.2f"%(acc))
...
# calculate performance metrics using the test set

y_predt = clf.predict(X_test)
acct=accuracy_score(y_test, y_predt)
print ("The performance of the GNB using the test set: %.2f"%(acct))
...
print("Confusion Matrix of GNB using the test set:")
print(conf_matrixt)

print("\nClassification Report of GNB using the test set:")
