...
print ("The performance of the SVC is using the test set: %.2f"%(acct))
...
# Display performance results
print("Confusion Matrix for SVC with the test set:")
print(conf_matrixt)

print("\nClassification Report for SVC with the test set:")
